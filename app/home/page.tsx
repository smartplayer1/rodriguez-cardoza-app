...
import CuentasBanco from '../../components/CuentasBanco';
import Sucursal from '../../components/Sucursal';
import ConceptosContables from '../../components/ConceptosContables';
...
import CategoriasArticulo from '../../components/CategoriasArticulo';
...
import ReporteGestionCaja from '../../components/ReporteGestionCaja';
...
export default function MainMenuPage() {
  ...
  const menuItems = [
    ...
    { id: 'empleados', label: 'Empleados', icon: UserCircle, href: '/empleado' },
