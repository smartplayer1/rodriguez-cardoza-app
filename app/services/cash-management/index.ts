...
const buildQueryString = (filters?: Omit<GetCashManagementFilters, 'baseUrl'>) => {
  if (!filters) {
    return '';
  }
...
const buildConversionQueryString = (filters?: Omit<GetCashManagementConversionFilters, 'baseUrl'>) => {
  if (!filters) {
    return '';
  }
...
const buildOutflowQueryString = (filters?: Omit<GetCashManagementOutflowFilters, 'baseUrl'>) => {
  if (!filters) {
    return '';
  }
...
const buildCashRegisterQueryString = (filters?: Omit<GetCashRegisterFilters, 'baseUrl'>) => {
  if (!filters) {
    return '';
  }
...
export const getCashManagementRecords = async (
  ...
  const endpoint = resolveServiceUrl(`/api/billing/cash-management${queryString}`, {
...
export const getCashManagementConversions = async (
  ...
  const endpoint = resolveServiceUrl(`/api/billing/cash-management/conversion${queryString}`, {
    baseUrl: filters?.baseUrl,
  });
...
export const getCashManagementOutflows = async (
  ...
  const endpoint = resolveServiceUrl(`/api/billing/cash-management/outflow${queryString}`, {
    baseUrl: filters?.baseUrl,
  });
...
export const getCashRegisters = async (
  ...
  const endpoint = resolveServiceUrl(`/api/billing/cash-register${queryString}`, {
    baseUrl: filters?.baseUrl,
  });
...
export const getCashRegisterById = async (
  ...
  const endpoint = resolveServiceUrl(`/api/billing/cash-register/${id}`, { baseUrl });
...
export const createCashManagementConversion = async (
  ...
  const response = await fetch(resolveServiceUrl('/api/billing/cash-management/conversion'), {
    method: 'POST',
    headers: createJsonHeaders(cookieHeader),
...
export const createCashManagementOutflow = async (
  ...
  const response = await fetch(resolveServiceUrl('/api/billing/cash-management/outflow'), {
    method: 'POST',
    headers: createJsonHeaders(cookieHeader),
    body: JSON.stringify(payload),
  });
...
export const createCashRegister = async (
  ...
  const response = await fetch(resolveServiceUrl('/api/billing/cash-register'), {
    method: 'POST',
    headers: createJsonHeaders(cookieHeader),
    body: JSON.stringify(payload),
  });
...
export const updateCashRegister = async (
  ...
  const response = await fetch(resolveServiceUrl(`/api/billing/cash-register/${id}`), {
    method: 'PUT',
    headers: createJsonHeaders(cookieHeader),
    body: JSON.stringify(payload),
  });
...
export const createCashManagement = async (
  ...
  const response = await fetch(resolveServiceUrl('/api/billing/cash-management'), {
    method: 'POST',
    headers: createJsonHeaders(cookieHeader),
    body: JSON.stringify(payload),
  });
...
export const closeCashManagement = async (
  ...
  const response = await fetch(resolveServiceUrl(`/api/billing/cash-management/${id}/close`), {
    method: 'POST',
    headers: createJsonHeaders(cookieHeader),
    body: JSON.stringify(payload),
  });
